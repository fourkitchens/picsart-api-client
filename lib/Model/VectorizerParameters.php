...
/**
 * VectorizerParameters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VectorizerParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VectorizerParameters';
    ...
    {
        $this->container['downscale_to'] = isset($data['downscale_to']) ? $data['downscale_to'] : 2048;
    }
     ...
     * @return int
     */
    public function getDownscaleTo()
    {
        return $this->container['downscale_to'];
    }

    /**
     * Sets downscale_to
     *
     * @param int $downscale_to Large images can be downscaled. Use -1 to turn off downscaling. Otherwise the image is scaled by 0.5 until max(width, height) < downscale_to.
     *
     * @return $this
     */
    public function setDownscaleTo($downscale_to)
    {
        $this->container['downscale_to'] = $downscale_to;

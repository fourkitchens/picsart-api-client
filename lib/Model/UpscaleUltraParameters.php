...
/**
 * UpscaleUltraParameters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpscaleUltraParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpscaleUltraParameters';
...
self::MODE_AUTO,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mode'] = isset($data['mode']) ? $data['mode'] : 'sync';
    }

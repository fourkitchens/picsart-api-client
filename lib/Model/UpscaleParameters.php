...
/**
 * UpscaleParameters Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpscaleParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpscaleParameters';
...
'format' => 'getFormat'    ];
    ...
    const UPSCALE_FACTOR_X2 = 'x2';
const UPSCALE_FACTOR_X4 = 'x4';
const UPSCALE_FACTOR_X6 = 'x6';
const UPSCALE_FACTOR_X8 = 'x8';
...
const FORMAT_WEBP = 'WEBP';
    ...
    {
        return [
            self::UPSCALE_FACTOR_X2,
self::UPSCALE_FACTOR_X4,
self::UPSCALE_FACTOR_X6,
self::UPSCALE_FACTOR_X8,        ];
    }
    /**
     * Gets allowable values of the enum
     *
...
self::FORMAT_WEBP,        ];
    ...
    {
        $this->container['upscale_factor'] = isset($data['upscale_factor']) ? $data['upscale_factor'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['upscale_factor'] === null) {
            $invalidProperties[] = "'upscale_factor' can't be null";
        }
     ...
     * Sets upscale_factor
     *
     * @param string $upscale_factor Choose one of the upscale factors. The option are as follows   * 2x   * 4x   * 6x   * 8x
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getUpscaleFactorAllowableValues();
        if (!in_array($upscale_factor, $allowedValues, true)) {

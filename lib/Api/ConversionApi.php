...
class ConversionApi
{
     ...
     */
    public function vectorizerPost()
    {
        list($response) = $this->vectorizerPostWithHttpInfo();
        return $response;
    }

    /**
     * Operation vectorizerPostWithHttpInfo
     *
     * Image Vectorizer
     *
     *
     ...
     */
    public function vectorizerPostWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->vectorizerPostRequest();
     ...
     */
    public function vectorizerPostAsync()
    {
        return $this->vectorizerPostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation vectorizerPostAsyncWithHttpInfo
     *
     * Image Vectorizer
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function vectorizerPostAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->vectorizerPostRequest();
    ...
    /**
     * Create request for operation 'vectorizerPost'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function vectorizerPostRequest()
    {

        $resourcePath = '/vectorizer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

...
/**
 * StyleTransferApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class StyleTransferApi
{
     ...
     */
    public function styletransferPost()
    {
        list($response) = $this->styletransferPostWithHttpInfo();
        return $response;
    }

    /**
     * Operation styletransferPostWithHttpInfo
     *
     * Style Transfer
     *
     *
     ...
     */
    public function styletransferPostWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->styletransferPostRequest();
    ...
    /**
     * Operation styletransferPostAsync
     *
     * Style Transfer
     *
     *
     ...
     */
    public function styletransferPostAsync()
    {
        return $this->styletransferPostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation styletransferPostAsyncWithHttpInfo
     *
     * Style Transfer
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function styletransferPostAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->styletransferPostRequest();
    ...
    /**
     * Create request for operation 'styletransferPost'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function styletransferPostRequest()
    {

        $resourcePath = '/styletransfer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

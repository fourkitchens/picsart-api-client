...
class AdjustApi
{
     ...
     */
    public function adjustPost()
    {
        list($response) = $this->adjustPostWithHttpInfo();
        return $response;
    }

    /**
     * Operation adjustPostWithHttpInfo
     *
     * Adjust
     *
     *
     ...
     */
    public function adjustPostWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->adjustPostRequest();
     ...
     */
    public function adjustPostAsync()
    {
        return $this->adjustPostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adjustPostAsyncWithHttpInfo
     *
     * Adjust
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adjustPostAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->adjustPostRequest();
    ...
    /**
     * Create request for operation 'adjustPost'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function adjustPostRequest()
    {
    ...
    {
        list($response) = $this->editPostWithHttpInfo();
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function editPostWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->editPostRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function editPostAsync()
    {
        return $this->editPostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function editPostAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->editPostRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function editPostRequest()
    {

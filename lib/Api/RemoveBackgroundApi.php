...
/**
 * RemoveBackgroundApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class RemoveBackgroundApi
{
     ...
     */
    public function removebgPost()
    {
        list($response) = $this->removebgPostWithHttpInfo();
        return $response;
    }

    /**
     * Operation removebgPostWithHttpInfo
     *
     * Remove & Change Background
     *
     *
     ...
     */
    public function removebgPostWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->removebgPostRequest();
     ...
     */
    public function removebgPostAsync()
    {
        return $this->removebgPostAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation removebgPostAsyncWithHttpInfo
     *
     * Remove & Change Background
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removebgPostAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->removebgPostRequest();
    ...
    /**
     * Create request for operation 'removebgPost'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function removebgPostRequest()
    {

        $resourcePath = '/removebg';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
